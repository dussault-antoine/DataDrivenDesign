...
X = pandas.read_excel("dashboard_data_zeina.xlsx",sheet_name=0,header=0,index_col=0)
...
print('singular values', acp.singular_values_**2/n)
...
indSupp = pandas.read_excel("Dashboard data.xlsx",sheet_name=1,header=0,index_col=0)
print(indSupp)
...
vsQuali = pandas.read_excel("Dashboard data.xlsx",sheet_name=1,header=0,index_col=0)
print(vsQuali)
"""
